  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <form onSubmit={handleUpdate} className="space-y-6">
        ...
        {['idea_candle', 'signal_candle', 'entry_candle', 'line_graph_candle', 'hour_candle', 'two_hour_candle', 'breakeven_candle', 'take_profit1_candle', 'take_profit2_candle'].map((candleType) => (
